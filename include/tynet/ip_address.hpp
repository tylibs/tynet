#ifndef TYNET_IP_ADDRESS_H_
#define TY_NET_IP_ADDRESS_H_
#include <stdint.h>
...
public:
    ...
    bool fromString(const etl::istring &address) { return fromString(address.c_str()); }
    ...
    etl::istring   toString(bool includeZone = false) const;
